...
//	{
//		if (arrFlag[robot.curPosY - 1][robot.curPosX].marked != index)
//		{
...
//	{
//		if (arrFlag[robot.curPosY][robot.curPosX - 1].marked != index)
//		{
...
//
//				setTextColor(RESET_COLOR);
//				drawMatrix(arr, sizeMatrix[0], sizeMatrix[1], *maxLen, 20, 4 + amount);
//
//				//for one or two player(s)
//				ofstream fileOutput;
...
//					R.amountCell = 1;
//					R.sumTotal = 0;
//					explorePath(arr, arrFlag, robotP[i].curPosX, robotP[i].curPosY, step, store[i], ac, i + 1);
//					robotP[i].sumTotal = store[i][0] + R.sumTotal;
//					robotP[i].amountCell = R.amountCell;
//
//					cout << "\n";
//
//					fileOutput.open("output.txt",ios::app);
//					fileOutput << "Robot [" << i + 1 << "]: " << R.amountCell << '\n';
...
//					arrFlag[robotP[i].curPosY][robotP[i].curPosX].beginPos = false;
//					arrFlag[robotP[i].curPosY][robotP[i].curPosX].character = "";
//
//					cout << '\n';
//					cout << '\n';
//
...
//				cout << '\n';
//
//				cout << "\tSo nguoi choi toi da la 2 nguoi.\n";
//				cout << '\n';
//
//				setTextColor(RED_COLOR);
//				cout << "\tCHU THICH:" << '\n';
...
//				cout << "\t2. NEU 2 ROBOT CUNG SO O DI DUOC, TONG SO DIEM KIEM DUOC SE DUOC DEM DI SO SANH." << "\n";
//
//				setTextColor(RED_COLOR);
//				cout << '\n';
//				cout << "\tNhan phim 'b' de quay lai!";
